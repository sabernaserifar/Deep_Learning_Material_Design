...
x_range=np.arange(-0.7,0.5,0.01)
fig1 = plt.figure()
...
plt.xlim(-0.7,0.5)
plt.ylim(-0.7,0.5)
plt.title('OCOH Prediction Results for Training Set (Size=1184)')
...
plt.xlim(-0.7,0.5)
plt.ylim(-0.7,0.5)
plt.title('OCOH Prediction Results for Validation Set (Size=100)')
plt.xlabel('AdE_ReQM/eV')
plt.ylabel('AdE_Preiction/eV')
plt.legend()
fig2.savefig('Fig_Validation.pdf')

x_range=np.arange(-0.7,0.6,0.01)
fig3 = plt.figure()
...
plt.xlabel('AdE_ReQM/eV')
plt.ylabel('AdE_Preiction/eV')
plt.title('OCOH Prediction Results for Testing Set (Size=100)')
plt.legend()
